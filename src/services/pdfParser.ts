...
export async function parseUniversityPDF(
  ...
  try {
    ...
    // Use chunking for large PDFs (>20K chars)
    const useChunking = pdfText.length > 20000;
    console.log(useChunking ? '📦 Using chunked parsing for large PDF' : '📄 Using single-pass parsing');
